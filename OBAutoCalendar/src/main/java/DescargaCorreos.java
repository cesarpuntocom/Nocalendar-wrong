...
public class DescargaCorreos{
   ...
   public static List<Correo> getCorreos(String email, String pass, String carpetaInbox, String carpetaLeidos)
   {
      //set properties 
      ...
      try {
         ...
         Folder inbox = store.getFolder(carpetaInbox);
         Folder alreadyRead = store.getFolder(carpetaLeidos);
         ...
         alreadyRead.open(Folder.READ_WRITE);
 ...
 //              m.setFlag(Flags.Flag.DELETED, true);
  ...
  //       inbox.copyMessages(mensajes, alreadyRead);
         inbox.close(true);
         alreadyRead.close(true);
         store.close();
