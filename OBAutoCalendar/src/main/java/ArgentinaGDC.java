...
// This class represents the way we will process mails from GDC Argentina and convert them into Calendar.Event objects
   ...
   private Event event;
   public static String carpetaInbox = "GDC_Notificaciones";
   public static String carpetaLeidos = "INBOX/provisional-GDC";
   ...
   public static String getCalendarioAsignado2() { return calendarioAsignado2; }
